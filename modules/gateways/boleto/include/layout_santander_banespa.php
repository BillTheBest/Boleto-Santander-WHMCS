<?php
// +----------------------------------------------------------------------+
// | Boleto Santander - v1.0                                              |
// +----------------------------------------------------------------------+
// |       |
// +----------------------------------------------------------------------+

// +----------------------------------------------------------------------+
// | TecSecret APP: <helpdesk@tecsecret.com.br>   |
// | Desenvolvimento por TecSecret: http://tecsecret.com.br		      |
// +----------------------------------------------------------------------+
?>
...
<meta name="Generator" content="Boleto Santander - www.tecsecret.com.br" />
<style type=text/css>
...
número</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top width=298 height=12> 
  <span class="campo"><?php echo $dadosboleto["cedente"];?>></td>
